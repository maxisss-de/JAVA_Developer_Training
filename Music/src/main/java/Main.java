public class Main {                       // Это класс для реализации
    ...
    public static void main(String[] args) throws Exception {    // 14.11) "throws Exception" добавляется вместе с этой командой см.14.9)
        Instrument[] instruments = {      // 11.1) Массив инструментов 
        ...
        boolean[][] shouldPlay = {                           // 12.1) Информация о том, когда, какой инструмент будет играть ([Первый индекс][] -номер инструмента, а [][второй индекс] - номер секунды.).
